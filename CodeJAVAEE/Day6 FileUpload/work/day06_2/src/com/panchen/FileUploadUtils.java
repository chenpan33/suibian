...
/**
 * @author panda
 * @description:作为uploadServlet工具类
...
public class FileUploadUtils{
    ...
    public static Map<String, Object> parseRequest(HttpServletRequest request){
        //变量 factory-->repository
        //其他变量: upload---map---items---iterator
        ...
        upload.setHeaderEncoding("utf-8");//解决上传的文件中文名乱码

        //使用map来存放
        Map<String, Object> map = new HashMap<>();

        try {
            //FileItem存放前端页面提交的每一个input
    ...
    //方法三 普通方法下面两个属性就可以
    private static void processFormField(FileItem item, Map<String, Object> map) throws UnsupportedEncodingException {
        String fieldName =item.getFieldName();
        String value=null;
